...
return [cljs.core.str((function (){var pred__49171 = cljs.core.instance_QMARK_;
var expr__49172 = reactive_val;
if(cljs.core.truth_(pred__49171.call(null,reagent.ratom.RAtom,expr__49172))){
return "ra";
} else {
if(cljs.core.truth_(pred__49171.call(null,reagent.ratom.RCursor,expr__49172))){
return "rc";
} else {
if(cljs.core.truth_(pred__49171.call(null,reagent.ratom.Reaction,expr__49172))){
return "rx";
} else {
if(cljs.core.truth_(pred__49171.call(null,reagent.ratom.Track,expr__49172))){
return "tr";
} else {
return "other";
}
