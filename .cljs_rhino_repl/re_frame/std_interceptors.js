...
var vec__48817_48820 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_48821 = cljs.core.nth.call(null,vec__48817_48820,(0),null);
var only_after_48822 = cljs.core.nth.call(null,vec__48817_48820,(1),null);
var db_changed_QMARK__48823 = (cljs.core.some_QMARK_.call(null,only_before_48821)) || (cljs.core.some_QMARK_.call(null,only_after_48822));
if(db_changed_QMARK__48823){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_48821);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_48822);
...
var map__48830 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48830__$1 = ((((!((map__48830 == null)))?((((map__48830.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48830.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48830):map__48830);
var db = cljs.core.get.call(null,map__48830__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__48830__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__48838 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48838__$1 = ((((!((map__48838 == null)))?((((map__48838.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48838.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48838):map__48838);
var coeffects = map__48838__$1;
var event = cljs.core.get.call(null,map__48838__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__46688__auto___48841 = arguments.length;
var i__46689__auto___48842 = (0);
while(true){
if((i__46689__auto___48842 < len__46688__auto___48841)){
args__46695__auto__.push((arguments[i__46689__auto___48842]));

var G__48843 = (i__46689__auto___48842 + (1));
i__46689__auto___48842 = G__48843;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__46696__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq48840){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48840));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__45472__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__46695__auto__ = [];
var len__46688__auto___48849 = arguments.length;
var i__46689__auto___48850 = (0);
while(true){
if((i__46689__auto___48850 < len__46688__auto___48849)){
args__46695__auto__.push((arguments[i__46689__auto___48850]));

var G__48851 = (i__46689__auto___48850 + (1));
i__46689__auto___48850 = G__48851;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__46696__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__48844_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__48845_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__48845_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq48846){
var G__48847 = cljs.core.first.call(null,seq48846);
var seq48846__$1 = cljs.core.next.call(null,seq48846);
var G__48848 = cljs.core.first.call(null,seq48846__$1);
var seq48846__$2 = cljs.core.next.call(null,seq48846__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__48847,G__48848,seq48846__$2);
});
