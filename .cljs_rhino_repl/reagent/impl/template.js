...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__46124__auto__,writer__46125__auto__,opt__46126__auto__){
return cljs.core._write.call(null,writer__46125__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__48062 = o;
(G__48062[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__48064__i < G__48064__a.length) {G__48064__a[G__48064__i] = arguments[G__48064__i + 0]; ++G__48064__i;}
  args = new cljs.core.IndexedSeq(G__48064__a,0);
} 
...
if(cljs.core.truth_((function (){var and__45460__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__45460__auto__){
var and__45460__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__48071 = jsprops;
(G__48071["defaultValue"] = value);

(G__48071["onChange"] = ((function (G__48071,v,value,on_change){
return (function (p1__48068_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__48068_SHARP_);
});})(G__48071,v,value,on_change))
);

(G__48071["ref"] = ((function (G__48071,v,value,on_change){
return (function (p1__48069_SHARP_){
return (this$["cljsInputElement"] = p1__48069_SHARP_);
});})(G__48071,v,value,on_change))
);
...
var vec__48078 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__48078,(0),null);
var id = cljs.core.nth.call(null,vec__48078,(1),null);
var class$ = cljs.core.nth.call(null,vec__48078,(2),null);
...
var jsprops = ({"argv": v});
var temp__6507__auto___48083 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6507__auto___48083 == null)){
} else {
var key_48084 = temp__6507__auto___48083;
(jsprops["key"] = key_48084);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__48086 = (new reagent.impl.template.NativeWrapper());
(G__48086["name"] = c);
...
var len__46688__auto___48092 = arguments.length;
var i__46689__auto___48093 = (0);
while(true){
if((i__46689__auto___48093 < len__46688__auto___48092)){
args__46695__auto__.push((arguments[i__46689__auto___48093]));

var G__48094 = (i__46689__auto___48093 + (1));
i__46689__auto___48093 = G__48094;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__46696__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq48090){
var G__48091 = cljs.core.first.call(null,seq48090);
var seq48090__$1 = cljs.core.next.call(null,seq48090);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__48091,seq48090__$1);
});
...
break;
default:
var G__48098 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__48098;
continue;
...
var n__46488__auto___48101 = a.length;
var i_48102 = (0);
while(true){
if((i_48102 < n__46488__auto___48101)){
(a[i_48102] = reagent.impl.template.as_element.call(null,(a[i_48102])));

var G__48103 = (i_48102 + (1));
i_48102 = G__48103;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__46488__auto___48104 = a.length;
var i_48105 = (0);
while(true){
if((i_48105 < n__46488__auto___48104)){
var val_48106 = (a[i_48105]);
if((cljs.core.vector_QMARK_.call(null,val_48106)) && ((reagent.impl.template.key_from_vec.call(null,val_48106) == null))){
(o["no-key"] = true);
} else {
}

(a[i_48105] = reagent.impl.template.as_element.call(null,val_48106));

var G__48107 = (i_48105 + (1));
i_48105 = G__48107;
continue;
} else {
}
...
var ctx = ({});
var vec__48111 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__48111,(0),null);
var derefed = cljs.core.nth.call(null,vec__48111,(1),null);
...
var G__48115 = (cljs.core.count.call(null,argv) - first_child);
switch (G__48115) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__48115){
